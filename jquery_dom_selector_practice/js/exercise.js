 ...
 */
 	...
 	//function question7 () {
 	//	$("h1").replaceWith("<h1>jQuery Ninja</h1>");
 	//}
...
/**
 * Question 8:
 * Have the following code execute when button 3 is clicked. Write a JavaScript 
 * comment with a description of what happened. 
 ...
 */
	...
	function question9 () {
		$("p").css({color: "blue", fontFamily: "Georgia, serif"});
	}
